...
<div class="form-wrapper mt-4">
    <div class="glass-card max-w-md mx-auto">
        ...
        <form action="<?= BASE_URL ?>/producto/create" method="POST">
            ...
            <div class="form-group mb-3">
                <label>Detalle</label>
                <textarea name="detalle" class="form-control" rows="4"><?= htmlspecialchars($producto['detalle'] ?? '') ?></textarea>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <input
                    ...
                    name="existencias"
                    class="form-control"
                    value="<?= htmlspecialchars($producto['existencias'] ?? '0') ?>"
                    required>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <input
                    ...
                    name="ruta_imagen"
                    class="form-control"
                    value="<?= htmlspecialchars($producto['ruta_imagen'] ?? '') ?>">
            </div>
            ...
            <div class="form-check mb-4">
                <input
                    ...
                    id="activo"
                    name="activo"
                    <?= !isset($producto['activo']) || !empty($producto['activo']) ? 'checked' : '' ?>>
