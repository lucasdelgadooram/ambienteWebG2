...
<div class="form-wrapper mt-4">
    ...
    <div class="glass-card max-w-md mx-auto" style="width: 60%; padding: 40px;">
        ...
        <h2 class="mb-4" style="color: #2c3e50; font-weight: bold;">Editar Rol</h2>
        ...
        <form action="<?= BASE_URL ?>/rol/edit/<?= $data['rol']['id_rol'] ?>" method="POST">
            ...
            <div class="form-group mb-3">
                ...
                <input
                    ...
                    value="<?= htmlspecialchars($data['rol']['rol']) ?>"
